...
import { IoLogoHtml5, IoLogoCss3,IoIosGitCompare,IoMdGitNetwork   } from "react-icons/io";
          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<IoIosGitCompare  />} name={"CI/CD"} value={60} />
                <ProgressBar logo={<IoMdGitNetwork   />} name={"Git"} value={90} />
                <ProgressBar logo={<IoLogoDocker   />} name={"Docker"} value={95} />
                <ProgressBar logo={<SiAmazonaws  />} name={"AWS"} value={60} />
              </div>
            </div>
          </div>
          {/* right box */}
          <div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
            ...
            <div className="last2 flex flex-col gap-10">
              ...
              <SkillBox
                className=""
                logo={
                  <SiPostgresql className=" text-white bg-black rounded-full h-fit border-white overflow-hidden" />
                }
                black={"black"}
                white={"white"}
                skill={"PostgreSQL"}
